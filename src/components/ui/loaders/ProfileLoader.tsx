  ...
  return (
    <section className="flex-auto flex items-center justify-center text-white">
      <SkeletonTheme baseColor="#202020" highlightColor="#444">
        <div className="w-full md:min-w-[400px] md:max-w-[60%] h-full flex flex-col gap-5 py-3 px-15 rounded-2xl border-2 border-(--glass-border-light) bg-(--glass-fill-light) backdrop-blur-(--glass-blur)">
